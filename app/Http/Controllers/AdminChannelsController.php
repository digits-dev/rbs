<?php namespace App\Http\Controllers;
	...
	class AdminChannelsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Channel","name"=>"channel_name"];
			$this->col[] = ["label"=>"Status","name"=>"channel_status"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Channel Code','name'=>'channel_code','type'=>'text','validation'=>'required|min:1|max:10','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Channel','name'=>'channel_name','type'=>'text','validation'=>'required|min:1|max:25','width'=>'col-sm-5'];
			if(CRUDBooster::getCurrentMethod() == 'getEdit' || CRUDBooster::getCurrentMethod() == 'postEditSave' || CRUDBooster::getCurrentMethod() == 'getDetail') {
				$this->form[] = ['label'=>'Status','name'=>'channel_status','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'ACTIVE;INACTIVE'];
			}
