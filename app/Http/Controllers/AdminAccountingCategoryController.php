<?php namespace App\Http\Controllers;
	...
	class AdminAccountingCategoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "accounting_category";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-md-5'];
