              ...
              <tr>
                <td>
                  <div class="col-md-12">
                    ...
                    <input type="hidden" class="form-control" name="requested_at" id="{{$data->requested_at}}" value="{{$data->requested_at}}">
                    <input type="hidden" class="form-control" name="date_receipt" id="{{$data->date_receipt}}" value="{{$data->date_receipt}}">
                ...
                <!-- <input type="hidden" class="form-control" name="checkbox{{$data->id}}" value="{{$data->id}}"> -->
                @if($data->error == 1 && $data->status == 'DISAPPROVED')
                <td>
                  <img src="{{asset($errorpic)}}" alt="" height=30px width=30px>
                </td>
                @elseif(($data->error == 0 || $data->error == null) && $data->status == 'REQUESTED')
                <td>
                  <!-- <div class="chk">
                    <label><input type="checkbox" id="{{$data->id}}"  class="chk1"></label>
                  </div>
...
//--------------------------------------------------
  ...
  //       $(".disapprovedB").attr("disabled", true);
  //          $(".approvedB").attr("disabled", true);
